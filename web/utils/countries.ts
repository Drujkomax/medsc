export const countries = [
  ...
  { code: 'AR', name: { ru: 'Аргентина', en: 'Argentina', uz: 'Argentina' }, flag: '🇦🇷' },
  { code: 'BE', name: { ru: 'Бельгия', en: 'Belgium', uz: 'Belgiya' }, flag: '🇧🇪' },
  { code: 'BY', name: { ru: 'Беларусь', en: 'Belarus', uz: 'Belarus' }, flag: '🇧🇾' },
  { code: 'BG', name: { ru: 'Болгария', en: 'Bulgaria', uz: 'Bolgariya' }, flag: '🇧🇬' },
  { code: 'BR', name: { ru: 'Бразилия', en: 'Brazil', uz: 'Braziliya' }, flag: '🇧🇷' },
  ...
  { code: 'GR', name: { ru: 'Греция', en: 'Greece', uz: 'Gretsiya' }, flag: '🇬🇷' },
  { code: 'DK', name: { ru: 'Дания', en: 'Denmark', uz: 'Daniya' }, flag: '🇩🇰' },
  { code: 'EG', name: { ru: 'Египет', en: 'Egypt', uz: 'Misr' }, flag: '🇪🇬' },
  { code: 'IL', name: { ru: 'Израиль', en: 'Israel', uz: 'Isroil' }, flag: '🇮🇱' },
  { code: 'IN', name: { ru: 'Индия', en: 'India', uz: 'Hindiston' }, flag: '🇮🇳' },
  { code: 'ID', name: { ru: 'Индонезия', en: 'Indonesia', uz: 'Indoneziya' }, flag: '🇮🇩' },
  { code: 'IE', name: { ru: 'Ирландия', en: 'Ireland', uz: 'Irlandiya' }, flag: '🇮🇪' },
  ...
  { code: 'LV', name: { ru: 'Латвия', en: 'Latvia', uz: 'Latviya' }, flag: '🇱🇻' },
  { code: 'LT', name: { ru: 'Литва', en: 'Lithuania', uz: 'Litva' }, flag: '🇱🇹' },
  { code: 'LU', name: { ru: 'Люксембург', en: 'Luxembourg', uz: 'Lyuksemburg' }, flag: '🇱🇺' },
  { code: 'MY', name: { ru: 'Малайзия', en: 'Malaysia', uz: 'Malayziya' }, flag: '🇲🇾' },
  { code: 'MX', name: { ru: 'Мексика', en: 'Mexico', uz: 'Meksika' }, flag: '🇲🇽' },
  { code: 'NL', name: { ru: 'Нидерланды', en: 'Netherlands', uz: 'Niderlandiya' }, flag: '🇳🇱' },
  { code: 'NO', name: { ru: 'Норвегия', en: 'Norway', uz: 'Norvegiya' }, flag: '🇳🇴' },
  { code: 'AE', name: { ru: 'ОАЭ', en: 'UAE', uz: 'BAA' }, flag: '🇦🇪' },
  ...
  { code: 'RO', name: { ru: 'Румыния', en: 'Romania', uz: 'Ruminiya' }, flag: '🇷🇴' },
  { code: 'RU', name: { ru: 'Россия', en: 'Russia', uz: 'Rossiya' }, flag: '🇷🇺' },
  { code: 'SA', name: { ru: 'Саудовская Аравия', en: 'Saudi Arabia', uz: 'Saudiya Arabistoni' }, flag: '🇸🇦' },
  { code: 'SG', name: { ru: 'Сингапур', en: 'Singapore', uz: 'Singapur' }, flag: '🇸🇬' },
  { code: 'SK', name: { ru: 'Словакия', en: 'Slovakia', uz: 'Slovakiya' }, flag: '🇸🇰' },
  { code: 'SI', name: { ru: 'Словения', en: 'Slovenia', uz: 'Sloveniya' }, flag: '🇸🇮' },
  { code: 'US', name: { ru: 'США', en: 'United States', uz: 'AQSH' }, flag: '🇺🇸' },
  { code: 'TW', name: { ru: 'Тайвань', en: 'Taiwan', uz: 'Tayvan' }, flag: '🇹🇼' },
  { code: 'TH', name: { ru: 'Таиланд', en: 'Thailand', uz: 'Tailand' }, flag: '🇹🇭' },
  ...
  { code: 'HR', name: { ru: 'Хорватия', en: 'Croatia', uz: 'Xorvatiya' }, flag: '🇭🇷' },
  ...
  { code: 'EE', name: { ru: 'Эстония', en: 'Estonia', uz: 'Estoniya' }, flag: '🇪🇪' },
  { code: 'ZA', name: { ru: 'Южная Африка', en: 'South Africa', uz: 'Janubiy Afrika' }, flag: '🇿🇦' },
